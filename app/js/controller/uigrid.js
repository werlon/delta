angular.module('primeiro')
    .controller('IndexControllerUigrid', IndexControllerUigrid);

IndexControllerUigrid.$inject = ['$scope','$timeout','AlertService','$filter'];
function IndexControllerUigrid($scope,$timeout,AlertService,$filter){
